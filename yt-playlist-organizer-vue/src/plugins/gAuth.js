...
const googleAuth = (function () {
  ...
  function Auth() {
    ...
    this.getAuthCode = (loginStateChangeHandler = null) => {
      return new Promise((resolve, reject) => {
        if (!this.instance) {
          reject("Instance isn't initialized")
          return
        }
        
        if (loginStateChangeHandler !== null) {
          this.instance.isSignedIn.listen(loginStateChangeHandler);
        }
